            ...
            <table class="table table-condensed">
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-right"><?php echo number_format($detail[$i]['QTY'] * $obat['PRICE']); ?></td>
                        </tr>
                <?php
                    }
                ?>
                ...
                <tr>
                    ...
                    <td class="emptyrow text-right"><?php echo number_format($result['TOTAL']); ?></td>
                </tr>
                </tbody>
            </table>
              <a href="pages/admin/rekam_medis/invoice3.php?&id=<?php echo $_GET[id]; ?>" class="btn btn-primary">Cetak Invoice</a>
        </div>
    </div>
</div>

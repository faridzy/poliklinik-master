...
<div class="panel panel-default">
    <div class="panel-heading">
        <button class="btn btn-primary" data-toggle="modal" data-target="#input">Tambah Data Pasien</button>
    </div>
            ...
            <table class="table table-striped table-hover" id="dataTables-example">
                ...
                ?>
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo $result[$x]['ADDRESS']; ?></td>
                            <td><?php echo $result[$x]['REGIS_DATE']; ?></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content box">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="">Input Pasien Baru</h4>
            </div>

...
<div class="panel panel-default">
    <div class="panel-heading">
        <button class="btn btn-primary" data-toggle="modal" data-target="#input">Tambah Data Obat</button>
    </div>
            ...
            <table class="table table-striped table-hover" id="dataTables-example">
                ...
                ?>
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo number_format($result[$x]['PRICE'],2); ?></td>
                            <td><?php echo $result[$x]['STOCK'] . " " . $result[$x]['UNIT']; ?></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content box">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="">Input Obat Baru</h4>
            </div>

...
<div class="panel panel-default">
    <div class="panel-heading">
        <button class="btn btn-primary" data-toggle="modal" data-target="#input">Tambah Data Poli</button>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content box">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="">Input Poli Baru</h4>
            </div>
